...
info_list <- get_past_info(my_city, past_day)

test_that("Testing get_past info", {
  ...
  expect_error(get_past_info(city_name = 5, "2017/8/30/"))  
  expect_error(get_past_info(city_name = "Istanbul", date = 2017830))  
