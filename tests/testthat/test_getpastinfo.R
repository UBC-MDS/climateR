...
test_that("Testing getpastinfo", {
  ...
  # input type:
  expect_match(typeof(my_city), 'character')  # type of a city input must be a string
  expect_match(typeof(past_day), 'character') # type of a date input must be a string
